...
@interface AirportLibrary2TableViewController ()

@end

@implementation AirportLibrary2TableViewController
{
...
-(void) loadFolders
{
    [User sharedUser].strPathDirectory = [[[[@"%@/Airportbriefing/" stringByAppendingString:self.airport.icaoidentifier] stringByAppendingString:@"/Important_links"] stringByAppendingString:@"/"] stringByAppendingString:[User sharedUser].strPath2Title];
