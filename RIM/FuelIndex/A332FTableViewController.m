...
#import "A332FTableViewController.h"


@interface A332FTableViewController ()

@end

@implementation A332FTableViewController
...
//    if ([self.navigationItem.title isEqualToString:@"Standard Fuel Distribution A33F with Center Tank"]) {
...
//    self.navBarStandartFuel.topItem.title = @"Non Standard Fuel Distribution A330-200";
    [self.navigationItem setTitle:@"Non Standard Fuel Distribution A33F with Center Tank"];
...
{
    [self.navigationItem setTitle:@"Standard Fuel Distribution A33F with Center Tank"];
...
//    self.txtTotalFuel.text = [[NSString alloc] initWithFormat:@"%d ", (int)self.sldFuel.value];
    ...
    } else if ( intTotalFuel > 9000 && intTotalFuel <= ((7300*intDensity)/1000)+9000)
    {
        ...
        self.txtTrimFuel.text = @"0";
        self.progFuelTrimTank.progress = 0;
    } else if ( intTotalFuel > ((7300*intDensity)/1000)+9000 && intTotalFuel <= ((7300*intDensity)/1000)+18300)
    {
        ...
        self.txtTrimFuel.text = @"0";
        self.progFuelTrimTank.progress = 0;
    } else if ( intTotalFuel > ((7300*intDensity)/1000)+18300 && intTotalFuel <= ((7300*intDensity)/1000)+3600+18300)
    {
        ...
        self.txtOuterFuelLeft.text = [[NSString alloc] initWithFormat:@"%li ", ((3650*intDensity)/1000)];
        self.txtOuterFuelRight.text = [[NSString alloc] initWithFormat:@"%li ", ((3650*intDensity)/1000)];
        self.txtTrimFuel.text = [[NSString alloc] initWithFormat:@"%ld ", (intTotalFuel-(18300+(2*((3650*intDensity)/1000))))];
        self.progFuelTrimTank.progress = (float)(intTotalFuel-(18300+(2*((3650*intDensity)/1000))))/(float)((6230*intDensity)/1000);
        self.txtCenterFuel.text = @"0";
        self.progFuelCenterTank.progress = 0;
    } else if ( intTotalFuel > ((7300*intDensity)/1000)+3600+18300 && intTotalFuel <= ((7300*intDensity)/1000)+((84000*intDensity)/1000)+3600)
    {
        ...
        NSLog(@"%f", (float)((intTotalFuel-(((7300*intDensity)/1000)+3600))/2)/(float)((32970*intDensity)/1000));
        self.txtInnerFuelRight.text = [[NSString alloc] initWithFormat:@"%ld ", (intTotalFuel-(((7300*intDensity)/1000)+3600))/2];
        ...
        self.txtCenterFuel.text = @"0";
        self.progFuelCenterTank.progress = 0;
    } else if ( intTotalFuel > ((7300*intDensity)/1000)+((84000*intDensity)/1000)+3600 && intTotalFuel <= ((139090*intDensity)/1000))
    {
        self.txtInnerFuelLeft.text = [[NSString alloc] initWithFormat:@"%li ", ((42000*intDensity)/1000)];
        ...
        NSInteger intFueled = (((42000*intDensity)/1000)*2)+(((3650*intDensity)/1000)*2)+3600;
        self.txtTrimFuel.text = [[NSString alloc] initWithFormat:@"%1.0f ", (((intTotalFuel-intFueled)*3.805)/100)+3600];
        self.progFuelTrimTank.progress = (float)((((intTotalFuel-intFueled)*3.805)/100)+3600)/(float)((6230*intDensity)/1000);
