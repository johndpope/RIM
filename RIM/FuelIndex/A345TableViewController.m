...
#import "A345TableViewController.h"


@interface A345TableViewController ()

@end

@implementation A345TableViewController
...
-(IBAction)formatInnerLeft1:(id)sender
{
    ...
    if ([self.txtInnerFuelLeft1.text intValue] > ((24716*intDensity)/1000)) {
        UIAlertView *message = [[UIAlertView alloc] initWithTitle:@"Caution"
        ...
        [message show];
        self.txtInnerFuelLeft1.text = [[NSString alloc] initWithFormat:@"%li ", ((24716*intDensity)/1000)];
    }
...
-(IBAction)formatInnerRight3:(id)sender
{
    ...
    if ([self.txtInnerFuelRight3.text intValue] > ((34805*intDensity)/1000)) {
        UIAlertView *message = [[UIAlertView alloc] initWithTitle:@"Caution"
                                                          message:@"Max Quantity exceeded!"
                                                         delegate:nil
                                                cancelButtonTitle:@"OK"
        ...
        [message show];
        self.txtInnerFuelRight3.text = [[NSString alloc] initWithFormat:@"%li ", ((34805*intDensity)/1000)];
    }
...
-(IBAction)formatInnerLeft2:(id)sender
{
    ...
    if ([self.txtInnerFuelLeft1.text intValue] > ((34805*intDensity)/1000)) {
        UIAlertView *message = [[UIAlertView alloc] initWithTitle:@"Caution"
                                                          message:@"Max Quantity exceeded!"
                                                         delegate:nil
                                                cancelButtonTitle:@"OK"
        ...
        [message show];
        self.txtInnerFuelLeft1.text = [[NSString alloc] initWithFormat:@"%li ", ((34805*intDensity)/1000)];
    }
...
-(IBAction)formatInnerRight4:(id)sender
{
    ...
    if ([self.txtInnerFuelRight3.text intValue] > ((24716*intDensity)/1000)) {
        UIAlertView *message = [[UIAlertView alloc] initWithTitle:@"Caution"
                                                          message:@"Max Quantity exceeded!"
                                                         delegate:nil
                                                cancelButtonTitle:@"OK"
        ...
        [message show];
        self.txtInnerFuelRight3.text = [[NSString alloc] initWithFormat:@"%li ", ((24716*intDensity)/1000)];
    }
...
-(IBAction)formatOuterLeft:(id)sender
{
    ...
    if ([self.txtOuterFuelLeft.text intValue] > ((6310*intDensity)/1000)) {
        UIAlertView *message = [[UIAlertView alloc] initWithTitle:@"Caution"
                                                          message:@"Max Quantity exceeded!"
                                                         delegate:nil
                                                cancelButtonTitle:@"OK"
        ...
        [message show];
        self.txtOuterFuelLeft.text = [[NSString alloc] initWithFormat:@"%li ", ((6310*intDensity)/1000)];
    }
...
-(IBAction)formatOuterRight:(id)sender
{
    ...
    if ([self.txtOuterFuelRight.text intValue] > ((6310*intDensity)/1000)) {
        UIAlertView *message = [[UIAlertView alloc] initWithTitle:@"Caution"
                                                          message:@"Max Quantity exceeded!"
                                                         delegate:nil
                                                cancelButtonTitle:@"OK"
        ...
        [message show];
        self.txtOuterFuelRight.text = [[NSString alloc] initWithFormat:@"%li ", ((6310*intDensity)/1000)];
    }
...
-(IBAction)formatCenter:(id)sender
{
    ...
    if ([self.txtCenterFuel.text intValue] > ((55133*intDensity)/1000)) {
        UIAlertView *message = [[UIAlertView alloc] initWithTitle:@"Caution"
                                                          message:@"Max Quantity exceeded!"
                                                         delegate:nil
                                                cancelButtonTitle:@"OK"
        ...
        [message show];
        self.txtCenterFuel.text = [[NSString alloc] initWithFormat:@"%li ", ((55133*intDensity)/1000)];
    }
    
    
}
-(IBAction)formatRearCenter:(id)sender
{
    NSInteger intDensity = [[self.lblDensity.text substringWithRange:NSMakeRange(2, 3)] intValue];
    
    if ([self.txtCenterFuel.text intValue] > ((19741*intDensity)/1000)) {
        UIAlertView *message = [[UIAlertView alloc] initWithTitle:@"Caution"
                                                          message:@"Max Quantity exceeded!"
                                                         delegate:nil
                                                cancelButtonTitle:@"OK"
        ...
        [message show];
        self.txtCenterFuel.text = [[NSString alloc] initWithFormat:@"%li ", ((19741*intDensity)/1000)];
    }
...
-(IBAction)formatTrim:(id)sender
{
    ...
    if ([self.txtTrimFuel.text intValue] > ((7886*intDensity)/1000)) {
        UIAlertView *message = [[UIAlertView alloc] initWithTitle:@"Caution"
                                                          message:@"Max Quantity exceeded!"
                                                         delegate:nil
                                                cancelButtonTitle:@"OK"
        ...
        [message show];
        self.txtTrimFuel.text = [[NSString alloc] initWithFormat:@"%li ", ((7886*intDensity)/1000)];
    }
...
//    double dblFuel = (168321/(fltDensity));
...
-(void) calcTrimSet {
    double c = 6-(7.85 * (([self.txtGWCG.text doubleValue]-20)/23));
    if (c < 0) {
    ...
    if ([self.txtGWCG.text doubleValue] <= 20 && [self.txtGWCG.text doubleValue] >= 15) {
        self.txtTrim.text = [[[NSString alloc]initWithFormat:@"%2.2f", 6.0] stringByAppendingString:@"° UP"];
    }
    else {
        if ([self.txtGWCG.text doubleValue] <= 45 && [self.txtGWCG.text doubleValue] >= 43) {
            self.txtTrim.text = [[[NSString alloc]initWithFormat:@"%2.2f", -1.85] stringByAppendingString:@"° DN"];
        }
    }
    if ([self.txtGWCG.text doubleValue] > 45 || [self.txtGWCG.text doubleValue] < 15) {
        
        self.txtTrim.text = @"XXXX";
    }
    self.lblTrim.text = @"";
    if ([self.txtGWCG.text doubleValue] >= 30 && [self.txtGWCG.text doubleValue] <= 43) {
...
-(IBAction)formatZFW:(id)sender
{
    if ([self.txtZFW.text length] >= 6) {
        if ([self.txtZFW.text intValue] > 225000) {
            UIAlertView *message = [[UIAlertView alloc] initWithTitle:@"Caution"
...
//    if ([self.navigationItem.title isEqualToString:@"Standard Fuel Distribution A340-500"]) {
...
-(IBAction)nonStdFuel:(id)sender
{
    ...
    [self.navigationItem setTitle:@"Non Standard Fuel Distribution A340-500"];
    ...
    NSInteger intTotalFuel = [self.txtInnerFuelLeft1.text intValue]+[self.txtInnerFuelLeft2.text intValue]+[self.txtInnerFuelRight3.text intValue] +[self.txtInnerFuelRight4.text intValue]+[self.txtOuterFuelLeft.text intValue]+[self.txtOuterFuelRight.text intValue]+[self.txtCenterFuel.text intValue]+[self.txtCenterRearFuel.text intValue]+[self.txtTrimFuel.text intValue];
...
{
    [self.navigationItem setTitle:@"Standard Fuel Distribution A340-500"];
...
//    self.txtTotalFuel.text = [[NSString alloc] initWithFormat:@"%d ", (int)self.sldFuel.value];
    ...
    if (intTotalFuel <= 12000) { //12000
        ...
        self.progFuelInnerLeft1.progress = (float)(intTotalFuel/4)/(float)((24716*intDensity)/1000);
        
        
        self.txtInnerFuelLeft2.text = [[NSString alloc] initWithFormat:@"%ld ", intTotalFuel/4];
        self.progFuelInnerLeft2.progress = (float)(intTotalFuel/4)/(float)((34805*intDensity)/1000);
        
        
        self.txtInnerFuelRight3.text = [[NSString alloc] initWithFormat:@"%ld ", intTotalFuel/4];
        self.progFuelInnerRight3.progress = (float)(intTotalFuel/4)/(float)((34805*intDensity)/1000);
        
        
        self.txtInnerFuelRight4.text = [[NSString alloc] initWithFormat:@"%ld ", intTotalFuel/4];
        self.progFuelInnerRight4.progress = (float)(intTotalFuel/4)/(float)((24716*intDensity)/1000);
    ...
    } else if ( intTotalFuel > 12000 && intTotalFuel <= 21000) //210000
    {
        ...
        self.progFuelInnerLeft1.progress = (float)3000/(float)((24716*intDensity)/1000);
        
        NSLog(@"%f", (float)3000/((24716*intDensity)/1000));
        
        self.txtInnerFuelLeft2.text = [[NSString alloc] initWithFormat:@"%d ", 3000];
        self.progFuelInnerLeft2.progress = (float)3000/(float)((34805*intDensity)/1000);
        
        NSLog(@"%f", (float)3000/((24716*intDensity)/1000));

        self.txtInnerFuelRight3.text = [[NSString alloc] initWithFormat:@"%d ", 3000];
        self.progFuelInnerRight3.progress = (float)3000/(float)((34805*intDensity)/1000);
        
        NSLog(@"%f", (float)3000/(float)((34805*intDensity)/1000));
        
        self.txtInnerFuelRight4.text = [[NSString alloc] initWithFormat:@"%d ", 3000];
        self.progFuelInnerRight4.progress = (float)3000/(float)((24716*intDensity)/1000);
        
        NSLog(@"%f", (float)3000/((24716*intDensity)/1000));
        
        self.txtOuterFuelLeft.text = [[NSString alloc] initWithFormat:@"%ld ", ((intTotalFuel-12000))/2];
        self.progFuelOuterLeft.progress = (float)((intTotalFuel-12000)/2)/(float)((6310*intDensity)/1000);
        self.txtOuterFuelRight.text = [[NSString alloc] initWithFormat:@"%ld ", ((intTotalFuel-12000))/2];
        self.progFuelOuterRight.progress = (float)((intTotalFuel-12000)/2)/(float)((6310*intDensity)/1000);
    ...
    } else if ( intTotalFuel > 21000 && intTotalFuel <= (81800))
    {
        ...
        self.progFuelInnerLeft1.progress = (float)(((intTotalFuel-21000)/4)+3000)/((24716*intDensity)/1000);
        ...
        self.progFuelInnerLeft2.progress = (float)(((intTotalFuel-21000)/4)+3000)/((34805*intDensity)/1000);
        ...
        self.progFuelInnerRight3.progress = (float)(((intTotalFuel-21000)/4)+3000)/((34805*intDensity)/1000);
        
            NSLog(@"%f", (float)((intTotalFuel-21000)/4)+3000/((34805*intDensity)/1000));
        
        self.txtInnerFuelRight4.text = [[NSString alloc] initWithFormat:@"%ld ", ((intTotalFuel-21000)/4)+3000];
        self.progFuelInnerRight4.progress = (float)(((intTotalFuel-21000)/4)+3000)/((24716*intDensity)/1000);
    ...
    } else if ( intTotalFuel > 81800 && intTotalFuel <= 116200)
    {
        ...
        self.progFuelInnerLeft1.progress = (float)18200/(float)((24716*intDensity)/1000);
        
        self.txtInnerFuelLeft2.text = [[NSString alloc] initWithFormat:@"%ld ", ((((intTotalFuel-81800)*22)/100)/2)+18200]; //22%
        self.progFuelInnerLeft2.progress = (float)(((((intTotalFuel-81800)*22)/100)/2)+18200)/(float)((34805*intDensity)/1000);
        
        self.txtInnerFuelRight3.text = [[NSString alloc] initWithFormat:@"%ld ", ((((intTotalFuel-81800)*22)/100)/2)+18200]; //22%
        self.progFuelInnerRight3.progress = (float)(((((intTotalFuel-81800)*22)/100)/2)+18200)/(float)((34805*intDensity)/1000);
        
        self.txtInnerFuelRight4.text = [[NSString alloc] initWithFormat:@"%d ", 18200];
        self.progFuelInnerRight4.progress = (float)18200/(float)((24716*intDensity)/1000);
        
        self.txtOuterFuelLeft.text = [[NSString alloc] initWithFormat:@"%d ",(4500)];
        self.progFuelOuterLeft.progress = (float)4500/(float)((6310*intDensity)/1000);
        
        self.txtOuterFuelRight.text = [[NSString alloc] initWithFormat:@"%d ",(4500)];
        self.progFuelOuterRight.progress = (float)4500/(float)((6310*intDensity)/1000);
        
        self.txtCenterFuel.text = [[NSString alloc] initWithFormat:@"%ld ", (((intTotalFuel-81800)*49)/100)]; //49%
        self.progFuelCenterTank.progress = (float)(((intTotalFuel-81800)*49)/100)/(float)((55130*intDensity)/1000);
        
        self.txtTrimFuel.text = [[NSString alloc] initWithFormat:@"%ld ", (((intTotalFuel-81800)*7)/100)];//7%
        self.progFuelTrimTank.progress = (float)(((intTotalFuel-81800)*7)/100)/(float)((7886*intDensity)/1000);
    ...
    } else if ( intTotalFuel > 116200 && intTotalFuel <= 142700)
    {
        ...
        self.progFuelInnerLeft2.progress = (float)25700/(float)((34805*intDensity)/1000);
        
        self.txtInnerFuelRight3.text = [[NSString alloc] initWithFormat:@"%d ", 25700];
        self.progFuelInnerRight3.progress = (float)25700/(float)((34805*intDensity)/1000);
        ...
        self.progFuelCenterTank.progress = (float)((((intTotalFuel-116200)*87)/100)+17000)/(float)((55133*intDensity)/1000);
        
        self.txtTrimFuel.text = [[NSString alloc] initWithFormat:@"%ld ", (((intTotalFuel-116200)*13)/100)+2400];//13%
        self.progFuelTrimTank.progress = (float)((((intTotalFuel-116200)*13)/100)+2400)/(float)((7886*intDensity)/1000);
        
        self.txtCenterRearFuel.text = @"0";
        self.progFuelCenterRearTank.progress = 0;
        
    } else if ( intTotalFuel > 142700 && intTotalFuel <= 156900)
    {
        self.txtInnerFuelLeft1.text = [[NSString alloc] initWithFormat:@"%d ", 18200];
        self.progFuelInnerLeft1.progress = (float)18200/(float)((24716*intDensity)/1000);
        ...
        self.txtCenterFuel.text = [[NSString alloc] initWithFormat:@"%d ", 40000];
        self.progFuelCenterTank.progress = (float)(40000)/(float)((55133*intDensity)/1000);
        
        self.txtTrimFuel.text = [[NSString alloc] initWithFormat:@"%d ", 5900];
        self.progFuelTrimTank.progress = (float)(5900)/(float)((7886*intDensity)/1000);
...
} else if ( intTotalFuel > 156900 && intTotalFuel <= (214422*intDensity)/1000) // 168321
{
...
-(void)calculateIndex
{
    NSInteger intIndex = [self.lblIndexInnerLeft1.text intValue]+ [self.lblIndexInnerLeft2.text intValue]+[self.lblIndexInnerRight3.text intValue]+[self.lblIndexInnerRight4.text intValue]+[self.lblIndexOuterRight.text intValue]+[self.lblIndexOuterLeft.text intValue]+[self.lblIndexCenterTank.text intValue]+[self.lblIndexCenterRearTank.text intValue]+[self.lblIndexTrimTank.text intValue];
