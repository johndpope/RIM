...
#import "Library3TableViewController.h"
#import "ReaderViewController.h"
#import "LibraryTableViewCell.h"
#import "User.h"

@interface Library3TableViewController ()

@end

@implementation Library3TableViewController
{
...
- (void)viewDidLoad {
    ...
    self.navigationItem.title = [User sharedUser].strPath3Title;
...
-(void) loadFolders
{
    [User sharedUser].strPathDirectory = [[[[@"%@/Library" stringByAppendingString:@"/"] stringByAppendingString:[User sharedUser].strPath2Title] stringByAppendingString:@"/"] stringByAppendingString:[User sharedUser].strPath3Title];
...
//        [User sharedUser].strPathTitle = title;
