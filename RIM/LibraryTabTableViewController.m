//
//  LibraryTabTableViewController.m
//  RIM
//
...
#import "LibraryTabTableViewController.h"

@interface LibraryTabTableViewController ()

@end

@implementation LibraryTabTableViewController
...
- (void)viewDidLoad {
    ...
    btnSearch = [[UIBarButtonItem alloc]  initWithImage:[UIImage imageNamed:@"search.png"] style:UIBarButtonItemStylePlain  target:self action:@selector(blank)];
